...
Con la aparición de Internet, los mercados se hacen mucho más grandes. Ahora puedes comerciar con casi cualquier persona del mundo, que tenga acceso a Internet. Hasta la aparición de una moneda virtual Bitcoin \ref{bitcoin_2009} el 24 de mayo de 2009, y otras, esto permite usar el mercado de interenet sin ser controlado por nadie. Concepto de anonimicidad muy importante ponerlo.


CoinWorked pagina que extrae bitcoin de tu pagina web.????

Moneda alternativas, monedas sociales, ECO, PUMA, FIORITO, RUPI, EPI, 
